...
user in an INI file next to PicardPortable.exe called PicardPortable.ini.
...
copy AppNamePortable.ini from this directory to PicardPortable.ini next to
PicardPortable.exe. The options in the INI file are as follows:
